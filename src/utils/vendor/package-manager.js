 ...
 *
 */
export function getPackageManagerCommand(packageManager = detectPackageManager(), verbose) {
...
export function getPackageManagerVersion(packageManager, cwd = process.cwd()) {
